...
import { Sparkles, Terminal, ArrowUpRight, FlaskConical } from 'lucide-react';
...
export default function Experiments({ experiments }: ExperimentsProps) {
  ...
  return (
    <section id="experiments" className="py-24 sm:py-32 px-6 sm:px-8 max-w-7xl mx-auto border-t border-white/[0.06]">
      {/* Section Header */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {experiments.map((exp, idx) => (
          <motion.div
            ...
            className="group rounded-3xl bg-surface-card border border-white/[0.08] p-6 hover:border-crimson-500/40 transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              ...
              <h3 className="text-xl font-bold text-white group-hover:text-crimson-400 transition-colors">
                {exp.title}
              </h3>
            ...
            <div className="pt-6 mt-6 border-t border-white/[0.06] flex flex-wrap items-center justify-between gap-2">
