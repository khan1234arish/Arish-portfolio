...
export default function About({ profile }: AboutProps) {
  return (
    <section id="about" className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/[0.06]">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
        ...
        >
          <div className="relative rounded-3xl bg-surface-card border border-white/[0.08] p-5 sm:p-8 overflow-hidden shadow-2xl">
            ...
            <div className="space-y-5 sm:space-y-6">
              {/* Terminal Title Bar */}
              <div className="flex items-center justify-between pb-3 sm:pb-4 border-b border-white/[0.06] text-[11px] font-mono text-text-muted">
              ...
              <div className="min-h-[200px] sm:min-h-[260px] rounded-2xl bg-gradient-to-b from-[#0e0e0e] to-[#141414] border border-white/[0.06] p-4 sm:p-6 flex flex-col justify-between relative overflow-hidden">
                ...
                <div className="my-auto text-center py-4 space-y-1 sm:space-y-2">
                  <div className="text-4xl sm:text-5xl lg:text-6xl font-black font-mono tracking-tighter text-white break-words">
                ...
                <div className="flex justify-between items-end text-[10px] font-mono text-text-muted border-t border-white/[0.04] pt-2.5 sm:pt-3">
                  <span>LOCATION: {profile.location}</span>
                  <span className="text-crimson-400 font-semibold">ACTIVE BUILDER</span>
                </div>
              </div>

              {/* Quick Philosophy Pillars */}
              <div className="grid grid-cols-2 gap-2.5 sm:gap-3 text-[11px] font-mono">
                <div className="p-2.5 sm:p-3 rounded-xl bg-surface-subtle border border-white/[0.04]">
        ...
        >
          <div>
            ...
            <h2 className="text-3xl sm:text-5xl font-black tracking-tight uppercase text-white leading-tight">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-4 border-t border-white/[0.06]">
